    ...
    public partial class frmProject : Form
    {
        ...
        private void frmProject_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                DGPrj.Columns[1].DefaultCellStyle.ForeColor = Color.Navy;
        ...
        private void Load_InCell()
        {
            try
            {
                ...
                textBox1.Text = PrjGV[0, Rw].Value.ToString();
            ...
            {
                Global.Create_OnLog(ex.Message + " :  Load In Cell....", "Alert");
        ...
        private void Load_DataGrid()
        {
            try
            {
                ...
                //{
                //    textBox1.Items.Add(PrjGV[0, x].Value);
                //}
            ...
            {
                Global.Create_OnLog(ex.Message + " :  Load GridData....","Alert");
        ...
        private void textBox1_Leave(object sender, EventArgs e)
        {
            ...
            {
                Ep.SetError(textBox1, "Type the File Name First..." +
            ...
            string l = textBox1.Text.Substring(0, 4).ToString();
            if ((l == "PRJ_") || (l == "prj_") || (l == "Prj_"))
            {
                textBox1.Text = "Prj_" + (textBox1.Text.ToUpper().Substring(4));
                Ep.Clear();
                return;
            }
            else
            {
                textBox1.Text = "Prj_" + textBox1.Text.ToUpper();
                Ep.Clear();
            }
        ...
        private void Format_Cells()
        {
                ...
                for (M = 0; M <= 9; M++)
                {
                    switch (M)
                    {
                        ...
                        case 5:
                            ...
                            if ((l >= 1210) || (l <= 540))
                            {
                                MessageBox.Show("Error: Idle rpm of Engine should be bet' 800 to 1200.", "Project Editor",
                        ...
                        case 6:
                            ...
                            if ((l >= 1210) || (l <= 540))
                            {
                                MessageBox.Show("Error: Min Rpm To start the Engine should be bet' 550 to 1200.", "Project Editor",
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                Global.Create_OnLog(ex.Message + " :  Format Cell.", "Alert");
        ...
        {
            textBox1.Text = ""; flg_New = true; textBox1.Focus();
        }
        ...
        private void mnuSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (textBox1.Text == "")
                {
                    Ep.SetError(textBox1, "Please select/Enter fileName.....");
                    textBox1.Focus();
                    return;
                }
                if (ComboBox2.Text == "")
                ...
                {
                    if (textBox1.Text == PrjGV[0, X].Value.ToString())
                    {
                        flg_New = false;
                        Rw = PrjGV.CurrentRow.Index;
                        break;
                ...
                if (flg_New == false)
                {
                    ...
                    cmd.CommandText = "UPDATE tblProject SET " +
                         ...
                         " WHERE ProjectFile = '" + textBox1.Text + "'";
                    cmd.Connection = Common.con;
                    cmd.ExecuteNonQuery();
                    Load_DataGrid();
                    //MessageBox.Show("Error Code:-11003" + ex.Message); 
                    MessageBox.Show("File Updated", "Project Editor",
                ...
                else if (flg_New == true)
                {
                    ...
                    cmd.ExecuteNonQuery();
                    Load_DataGrid();
                    MessageBox.Show("File Saved", "Project Editor",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                Global.Create_OnLog(ex.Message + " :  File Save....", "Alert");
        ...
        private void mnuDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result1 == DialogResult.Yes)
                {
                    ...
                    cdelete.CommandText = "Delete from tblProject where ProjectFile= '" + textBox1.Text + "'";
                    Common.Open_Connection("gen_db", "con");
                ...
                {
                    //Editors_DLL.Global.Create_OffLog("Alert", "file not Deleted...");
                    MessageBox.Show("File not Deleted", "Project File",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error Code:- 11006" + ex.Message, "Project Editor",
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
