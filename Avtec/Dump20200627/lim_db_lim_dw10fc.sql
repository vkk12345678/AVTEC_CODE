...
--
-- Table structure for table `lim_dw10fc`
--

DROP TABLE IF EXISTS `lim_dw10fc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `lim_dw10fc` (
  `Pn` float NOT NULL,
