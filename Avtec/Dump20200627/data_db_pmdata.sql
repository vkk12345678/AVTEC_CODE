...
--
-- Table structure for table `pmdata`
--

DROP TABLE IF EXISTS `pmdata`;
...
--
-- Dumping data for table `pmdata`
--

LOCK TABLES `pmdata` WRITE;
/*!40000 ALTER TABLE `pmdata` DISABLE KEYS */;
/*!40000 ALTER TABLE `pmdata` ENABLE KEYS */;
UNLOCK TABLES;
